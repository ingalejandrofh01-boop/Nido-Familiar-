...
const P = {
  ...
  documentos: '<rect class="f" x="3" y="5" width="18" height="14" rx="2.5"/><rect x="3" y="5" width="18" height="14" rx="2.5"/><circle cx="8.5" cy="11" r="2"/><path d="M5.5 16c.6-1.6 1.7-2.4 3-2.4s2.4.8 3 2.4M14 10h4M14 13h3"/>',
  mapa: '<path class="f" d="M3 6l6-2 6 2 6-2v14l-6 2-6-2-6 2z"/><path d="M3 6l6-2 6 2 6-2v14l-6 2-6-2-6 2zM9 4v14M15 6v14"/>',
  tesoro: '<rect class="f" x="3" y="9" width="18" height="11" rx="2"/><path d="M3 11a8 5 0 0 1 18 0v9H3zM3 13h18M11 12h2v3h-2z"/>',
