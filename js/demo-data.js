  ...
  return {
    ...
    cols: {
      ...
      messages: {
        ...
        t3: { text: 'Yo paso 🙋‍♂️', author: 'm1', createdAt: now - 7000000, replyTo: { id: 't2', author: 'm2', text: '¿Alguien puede pasar por pan de regreso?' }, reactions: { m2: '❤️', m4: '🙏' } },
